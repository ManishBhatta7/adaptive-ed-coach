-- Phase 1: Fix Critical Data Exposure Issues (Idempotent)
...
DROP POLICY IF EXISTS "Students can view their own learning profile" ON public.student_profiles;
DROP POLICY IF EXISTS "Teachers can view their students' learning profiles" ON public.student_profiles;
DROP POLICY IF EXISTS "Admins can view all learning profiles" ON public.student_profiles;
...
DROP POLICY IF EXISTS "Teachers can view assignments for their classrooms" ON public.classroom_assignments;
DROP POLICY IF EXISTS "Students can view assignments for their enrolled classrooms" ON public.classroom_assignments;
...
DROP POLICY IF EXISTS "Users can delete their own submissions within 24 hours" ON public.submissions;
DROP POLICY IF EXISTS "Students can delete their own unresolved doubts" ON public.doubts;
